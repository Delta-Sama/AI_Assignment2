...
bool Engine::Init(const char* title, int xpos, int ypos, int width, int height, int flags)
{
	...
	SOMA::Load("Aud/sans.mp3", "background", SOUND_MUSIC);
	SOMA::SetMusicVolume(18);
	SOMA::PlayMusic("background");

	SOMA::Load("Aud/ClickStart.mp3", "start", SOUND_SFX);
	SOMA::Load("Aud/Click1.mp3", "click1", SOUND_SFX);
	SOMA::Load("Aud/Click2.mp3", "click2", SOUND_SFX);
	SOMA::Load("Aud/Click3.mp3", "click3", SOUND_SFX);
	SOMA::Load("Aud/Click4.mp3", "click4", SOUND_SFX);
	SOMA::Load("Aud/Click5.mp3", "click5", SOUND_SFX);
	for (int i = 1; i <= 6; i++)
	{
